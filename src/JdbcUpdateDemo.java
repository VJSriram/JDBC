...
public class JdbcUpdateDemo {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
			...
			displayEmployee(myConn, "Vijay", "Sriram");
			
			// UPDATE the employee
			System.out.println("\nEXECUTING THE UPDATE FOR: Vijay sriram\n");
			
			int rowsAffected = myStmt.executeUpdate(
					"update employees " +
					"set email='vijay.sriram@luv2code.com' " + 
					"where last_name='sriram' and first_name='vijay'");
